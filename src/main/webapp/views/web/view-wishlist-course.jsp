...
<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function loadData() {
            try {
                const response = await apiRequestWithToken(environment.apiUrl + "/api/wishlist", {
                    method: 'GET',
                });
                ...
                if (response.length === 0) {
                    ...
                    Swal.fire({
                        title: "Chưa có khóa học nào trong danh sách yêu thích",
                        text: "Bạn chưa thêm khóa học nào vào danh sách yêu thích. Quay về trang chủ để khám phá các khóa học mới.",
                        icon: "warning",
                ...
                for (let i = 0; i < response.length; i++) {
                    ...
                    htmls += "  <div class='properties__card' data-id='" + course.courseId + "'>";
                    htmls += "    <div class='properties__img overlay1'>";
                    htmls += "      <a class='' href='#'><img src='" + course.imageUrl + "' alt=''></a>";
                    htmls += "    </div>";
                    ...
                    htmls += "        </div>";
                    htmls += "      </div>";
                    htmls += "      <a href='#' class='border-btn'>Tham gia học </a>";
                    htmls += "</div>";
                    htmls += "<i class='" + bookmarkClass + " fa-heart bookmark-icon'></i>";
                    htmls += "</div>";
                    htmls += "    </div>";
                    htmls += "  </div>";
                    htmls += "</div>";
