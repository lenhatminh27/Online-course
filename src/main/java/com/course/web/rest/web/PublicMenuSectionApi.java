...
@WebServlet("/api/public-menu-section/*")

public class PublicMenuSectionApi extends HttpServlet {
    ...
    private void handleGetMenuSectionsByCourse(Long courseId, HttpServletResponse resp) throws IOException {
        try {
            List<MenuSectionResponse> response = menuSectionService.getMenuSectionByCourseIdPublic(courseId);
